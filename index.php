...
<title>TCS Biosciences - Microbiological Supplies</title>
<!-- TCS Biosciences - for Microbiological Supplies -->
<meta name="description" content="TCS Biosciences supply Microbiological organisms and reagents for the Food, Water and Pharmaceutical industries in addition to kits for the medical diagnosis of a number of acquired infections and water quality assessment." />
<meta name="keywords" content="microbiology reagents, quality control organisms, diagnostic tests, medical diagnosis, Immunology, Fetal Bovine serum and albumin, Cryptosporidium and Giardia testing, Direct Toxicity Assessment Wastewater, Haematology, Serology, TCS Biosciences UK" />
<meta name="author" content="TCS Biosciences and Cliff Taylor@AnnWebCom.co.uk +44 1296 770848" />
<meta name="copyright" content="Copyright TCS Biosciences, AnnWebCom" />
<meta name="owner" content="TCS Biosciences" />
...
<div class="centered clinicalbg larger padded">HCV panels now available from TCS Biosciences <a class="button" href="https://www.tcsbiosciences.co.uk/human_serum_and_plasma_hvc_panels.php">More details...</a></li></div>

<div class="mainbody" id="homebody">

<div class="parallax-window site-header" data-parallax="scroll" data-speed="0.4" data-image-src="../images/all.jpg">
	<div class="site-header-wrap" id="overlay">
		<div class="inner-wrap">

<!-- inc header top -->

			<div class="site-branding" title="TCS Biosciences"><a href="index.php"><img class="noscreen" src="images/logo_print.png" width="90" height="90" alt="TCS Biosciences" /></a></div>

			<div id="header-menu">

				<div class="header-phone"><a href="tel:+441296714222"><i class="pe-7s-call pe-lg pe-va"></i>+44 (0)1296 714222</a></div>

				<ul>
					<li class="header-strap"><p>accuracy and quality as a science</p></li>
					<li class="header-basket noprint">
<!-- inc header basket -->
		<div class="header-basket">
			<div id="basket-label">Basket: <span id="basket_count" class="bold">0</span></div><div id="basket_button" title="go to basket"></div><div id="show_basket" class="show_basket" title="basket summary"></div>
			<div class="clear"></div>
		</div>
		<div id="basket-summary-panel"><div id="basket-summary-close"></div><div id="basket_summary"></div></div>
<!-- /inc header basket -->
					<a id="buyonline" href="https://www.tcsbiosciences.co.uk/catalog/">Buy Online</a>
					</li>
					<li class="header-catalogue noprint"><a id="viewcatalogue" href="https://www.tcsbiosciences.co.uk/product_guide.php">View Catalogue</a></li>
					<li class="header-search noprint">
<!-- inc quick search advanced -->
<form id="searchform" method="get" action="https://www.tcsbiosciences.co.uk/catalog/search_results.php">
<div class="header-search">

	<div id="show_search" class="show_search" title="search"><i class="pe-7s-search pe-2x pe-va"></i></div>

	<div class="clear"></div>

	<div id="advanced-search-panel">

		<div id="advanced-search-top"><p>Search</p></div>

		<div id="advanced-search-close"></div>

		<div class="searchinput" id="search-type">
		...
		<div class="searchinput" id="search-discounted">
		...
		<div class="searchinput" id="search-fulldesc">
...
<div id="search-brand"><label for="live_MF_ID">Filter by Brand: </label> &nbsp;<select class="smallselect" id="live_MF_ID" name="MF_ID"><option value="0">All Brands</option><option value='13'>Atlas Biologicals</option><option value='8'>Bio-Rad</option><option value='6'>BTF Precise Microbiology</option><option value='7'>Cellabs</option><option value='5'>Cytomark</option><option value='9'>Dimanco</option><option value='12'>Elisabeth Pharmacon</option><option value='10'>EY Laboratories</option><option value='11'>Hyserve</option><option value='3'>Moregate BioTech</option><option value='14'>R&amp;D Antibodies </option><option value='2'>South Pacific Sera</option><option value='1'>TCS Biosciences</option></select></div>
		<input type="button" class="button_small spaced" value="reset" onclick="document.getElementById('searchwords').value='';document.getElementById('live_MF_ID').value=0;document.getElementById('searchtype1').checked=false;document.getElementById('searchtype2').checked=false;document.getElementById('discounted').checked=false;document.getElementById('searchfulldesc').checked=false;document.getElementById('advanced-search-panel').style.display='none';document.getElementById('advsrchnoshow').style.display='none';document.getElementById('advsrchshow').style.display='inline';" onkeypress="document.getElementById('searchwords').value='';document.getElementById('live_MF_ID').value=0;document.getElementById('searchtype1').checked=false;document.getElementById('searchtype2').checked=false;document.getElementById('discounted').checked=false;document.getElementById('searchfulldesc').checked=false;document.getElementById('advanced-search-panel').style.display='none';document.getElementById('advsrchnoshow').style.display='none';document.getElementById('advsrchshow').style.display='inline';" />

		<input type="submit" class="button_red_small spaced" value="Search now" />
...
<!-- /inc quick search advanced -->
			...
			<a class="noprint" id="menushow" href="index.php#panelhome">&#9776; show menu</a>
			<a class="noprint" id="menuhide" href="index.php#mainbody">&#9776; hide menu</a>
...
<!-- inc header menu -->
			...
			<div id="mainmenu">
				...
				<ul id="site-menu">
					...
					<li class="drop" id="panelhome"><a class="adrop mouseandtouch" href="https://www.tcsbiosciences.co.uk/index.php?genre=all">Home</a></li>

					<li class="drop" id="panelpharma"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/pharmaceutical.php">Pharmaceutical</a><a class="adrop touchonly" href="index.php#site-menu">Pharmaceutical</a>
...
<!-- /include pharma menu  -->
					...
					<li class="drop" id="panelclinical"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/clinical.php">Clinical</a><a class="adrop touchonly" href="index.php#site-menu">Clinical</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /include clinical menu  -->
					...
					<li class="drop" id="panelfood"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/food.php">Food</a><a class="adrop touchonly" href="index.php#site-menu">Food</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /include food menu  -->								<div class="clear"></div>
					...
					<li class="drop" id="panelwater"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/water.php">Water</a><a class="adrop touchonly" href="index.php#site-menu">Water</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /include water menu  -->
					...
					<li class="drop" id="panelcontract"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/contract_ivd_manufacture.php">Contract Services</a><a class="adrop touchonly" href="index.php#site-menu">Contract Services</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /include contract menu  -->
					...
					<li class="drop" id="panelresources"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/techinfo.php">Resources</a><a class="adrop touchonly" href="index.php#site-menu">Resources</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<ul class="ul-group">
	...
	<li class="li-group"><a href="https://www.tcsbiosciences.co.uk/terms/index.php">Terms</a></li>
</ul>
<!-- /include resources menu  -->
								<div class="clear"></div>
								</div>
					...
					<li class="drop" id="panelcatalog"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/catalog/index.php?reset=reset">Products</a><a class="adrop touchonly" href="index.php#site-menu">Products</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- end of menu list -->
					...
					<li class="drop" id="panelnews"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/news.php">News</a><a class="adrop touchonly" href="index.php#site-menu">News</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /include news menu  -->
					...
					<li class="drop" id="panelcontact"><div class="sub-show">&nbsp;</div><a class="adrop mouseonly" href="https://www.tcsbiosciences.co.uk/contact_us.php">Contact</a><a class="adrop touchonly" href="index.php#site-menu">Contact</a>
						<div class="dropdown-fullwidth">
							<div class="menu-fullwidth">
...
<!-- /inc header menu -->
		...
		<div class="header-desc-wrap">
			...
			<div class="home-title"><h1>TCS Biosciences Ltd</h1></div>

			<div class="home-description">Serving the needs of clinical and industrial scientists for over 50 years.</div>

			<a href="index.php#contop" class="header-link">Read more</a>
...
<!-- /inc genre-links -->
		...
		<div class="header-scroll"><a href="index.php#contop"></a></div>
...
<!-- home page notice -->
	...
	<div class="column-50 floatleft">
		...
		<div class="padded" id="about">
			...
			<h3>Welcome to TCS Biosciences Ltd.</h3>

			<p>TCS is a manufacturer and distributor of laboratory reagents, test kits and quality control reagents for the Clinical, Pharmaceutical, Food and Water sectors. Our commitment to supplying quality and innovative products helps our customers to excel in the provision of clinical care, medicines, food and drinking water.</p>

			<p>In our 50 year history we have established ourselves as Europe's foremost supplier of animal blood and sera for microbiological use. We are also a prominent player in the UK water industry and in the European pharmaceutical market.</p>

			<p>At TCS, we are focused on developing our presence and product portfolio in each market sector, without compromising our core business value . . . . Quality.</p>

			<p><strong>TCS Biosciences, your partner: For Life.</strong></p>

			<p class="noprint"><a href="index.php#reveal" class="button pointer-down" id="showmore">Read more</a></p>
			...
			<div class="reveal" id="reveal">
				...
				<p class="noprint"><a href="index.php#about" class="button pointer-up" id="showless" style="display: none;">Show less</a></p>
	...
	<div class="page-scroll"><a href="index.php#twittercontainer"></a></div>
	...
	<div class="fullwidth">
		...
		<div class="column-50 floatleft">
			...
			<div class="padded" id="tcs-twitter">
				<a class="twitter-timeline" data-chrome="noborders transparent noscrollbar noheader nofooter" data-height="100px" data-width="100%" href="https://twitter.com/TCSBiosciences" data-widget-id="346012169499987968">Tweets by @TCSBiosciences</a>
		...
		<div class="column-20 floatleft centered">
			...
			<a class="follow-button noprint" href="https://twitter.com/TCSBiosciences">Follow us</a>
...
<div class="maincontainer newscontainer" id="newscontainer">
	...
	<div class="fullwidth padded noprint">
		...
		<h2 class="slider-heading">What's New at TCS?</h2>
	...
	<div class="fullwidth">
		...
		<div class="column-50 floatleft">
			...
			<div class="padded" id="tcs-fiftieth">
				...
				<h5>We would love to hear your feedback...</h5>
				<div class="clear"></div>			
			</div>
		...
		<div class="column-20 floatleft centered">
			...
			<a class="fiftieth-button" href="https://www.tcsbiosciences.co.uk/survey/">Give feedback</a>
...
<div class="contact-pane">
	...
	<div id="contactcontent">
		...
		<div id="contactphone" class="contactcontenton">
			...
			<p class="tight"><strong>t</strong>: <a href="tel:+441296714222">+44 (0)1296 714222</a> <br />
			<strong>f</strong>: +44 (0)1296 714806</p>
		</div>
		<div id="contactmail" class="contactcontentoff">
			<p class="tight"><a class="floatleftimg" href="mailto:sales@tcsgroup.co.uk?subject=From%20the%20TCS%20Biosciences%20website"><i class="pe-7s-mail pe-2x pe-va"></i> sales@tcsgroup.co.uk</a></p>
		</div>
		<div id="contactlocation" class="contactcontentoff">
			...
			<p class="tight">Botolph Claydon, Buckingham, <a href="https://www.tcsbiosciences.co.uk/find_us.php">MK18 2LR</a>, United Kingdom</p>
		</div>
...
<div class="smm-pane">
	...
	<div id="smmbuttons-wrapper">
		...
		<a href="https://twitter.com/TCSBiosciences"><img src="images/twitter_100.png" alt="Follow us on Twitter" /></a>
...
<div class="quicklinkspanel">
	<div class="quicklinks">
		<div id="quicklinkshome">
			<div class="padded">
				<h5><a class="quickheadinglink" href="https://www.tcsbiosciences.co.uk/index.php?genre=all">Home</a></h5>
				<ul>
...
<!-- 				<li><a class="quicklink" href="http://twitter.com/tcsbiosciences">Follow us on Twitter</a></li> -->
				</ul>
				<div class="spacer"></div>
				<div class="spacer"></div>
				<h5>TCS Biosciences Ltd</h5>
		...
		<div id="quicklinksaccreditations">
			<div class="padded">
				<img src="images/bsi_logo_12_2016_125.png" width="125" height="100" alt="BSI Registered Firm" title="BSI Registered Firm" class="floatrightimg" />
				<a href="http://www.reachready.co.uk"><img src="images/reach_ready_2017_125.png" height="100" alt="REACH Ready" title="REACH Ready" class="floatrightimg" /></a>
				<div class="separator"></div>
				<a href="http://www.pivotalscientific.com/ "><img src="images/psl-alliance-wht-125-100.png" height="100" alt="PSL Alliance" title="PSL Alliance" class="floatrightimg" /></a>
				<div class="separator"></div>
				<a href="http://www.bivda.co.uk/"><img src="images/bivda-2017-125-wht.png" width="125" height="125" alt="British In Vitro Diagnostics Association (BIVDA)" title="British In Vitro Diagnostics Association (BIVDA)" class="floatrightimg" /></a>
				<div class="separator"></div>
				<a href="http://www.serumindustry.org/"><img src="images/isia_125x75.png" width="125" height="75" alt="International Serum Industry Association" title="International Serum Industry Association" class="floatrightimg" /></a>
				<div class="separator"></div>
			</div>
		</div>
	<div class="spacer"></div>
...
<div class="printfooter noscreen" id="printfooter">
		<p><strong>TCS Biosciences Ltd</strong><br />
...
<div class="copyrightpanel" id="copyrightpanel">
	<div class="webmastercontainer">
		...
		<div class="copyright">&copy; Copyright 2001-2017 TCS Biosciences Ltd. - all rights reserved</div>
		<div class="separator"></div>
